module.exports = {
  ...
  // i.e: "-jackson howard foo" will trigger the command "foo",
  //      whereas "Jackson Howard foo" will do nothing at all.
  prefix:  "~jhow",

  // Your bot's user token. If you don't know what that is, go here:
  // https://discordapp.com/developers/applications/me
  // Then create a new application and grab your token.
  token: "Mjc3NDY4MjUxMTk2MzU4NjU4.C3eqbg.1elXpC2bpowh4Jrju4nfdMCbvSE",
